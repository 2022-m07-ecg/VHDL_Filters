...
-- Generated on: 2023-01-13 13:05:21
-- -------------------------------------------------------------
...
----------------------------------------------------------------
ARCHITECTURE rtl OF filter_highpass IS
  -- Local Functions
  -- Type Definitions
  TYPE delay_pipeline_type IS ARRAY (NATURAL range <>) OF integer; -- double
  -- Constants
  CONSTANT scaleconst1                    : integer := 1; -- double
  CONSTANT coeff_b1_section1              : integer := 1; -- double
  CONSTANT coeff_b2_section1              : integer := -2; -- double
  CONSTANT coeff_b3_section1              : integer := 1; -- double
  CONSTANT coeff_a2_section1              : integer := -1; -- double
  CONSTANT coeff_a3_section1              : integer := 1; -- double
  CONSTANT scaleconst2                    : integer := 1; -- double
  CONSTANT coeff_b1_section2              : integer := 1; -- double
  CONSTANT coeff_b2_section2              : integer := -2; -- double
  CONSTANT coeff_b3_section2              : integer := 1; -- double
  CONSTANT coeff_a2_section2              : integer := -2; -- double
  CONSTANT coeff_a3_section2              : integer := 1; -- double
  CONSTANT scaleconst3                    : integer := 1; -- double
  CONSTANT coeff_b1_section3              : integer := 1; -- double
  CONSTANT coeff_b2_section3              : integer := -1; -- double
  CONSTANT coeff_b3_section3              : integer := 0; -- double
  CONSTANT coeff_a2_section3              : integer := -1; -- double
  CONSTANT coeff_a3_section3              : integer := 0; -- double
  -- Signals
  ...
  SIGNAL delay_section3                   : integer := 0; -- double
...
BEGIN
  ...
  b2mul3 <= -delay_section3;

  a1sum3 <= inputconv3 - a2mul3;

  b1sum3 <= b1mul3 + b2mul3;

  output_typeconvert <= b1sum3;
